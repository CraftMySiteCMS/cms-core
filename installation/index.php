...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a class="brand-link">
                <img src="../admin/resources/images/identity/CraftMySite_Logo.svg" alt="<?=_ALT_LOGO?>" class="brand-image img-circle elevation-3">
                                ...
                                <form action="controller.php" role="form" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted">Le nom de la base de données sur laquelle vous souhaitez installer Craft My Website (Elle se créée <b>automatiquement</b> si elle n'existe pas encore)</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="bdd_login">Identifiant</label>
                                            <input type="text" name="bdd_login" class="form-control" id="bdd_login" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bdd_address" class="form-control" id="bdd_address" required>
                                            <small class="text-muted">Généralement <code>localhost</code>. Si localhost ne fonctionne pas, veuillez demander l'information à votre hébergeur.</small>
                                        </div>
                                        <hr>
                                        <h2>A propos du site :</h2>
                                        <div class="form-group">
                                            <label for="install_folder">Dossier d'installation</label>
                                            <input type="text" name="install_folder" class="form-control" id="install_folder" required>
                                            <small class="text-muted">Généralement <code>/</code>. Si CraftMySite se trouve dans un dossier, veuillez indiquer <code>/dossier/</code>.</small>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                        ...
                        <?php if(isset($_GET['step']) && $_GET['step'] == 2) : ?>
                            <div class="card">
                                ...
                                <form action="controller.php" role="form" method="post">
                                    ...
                                    <!-- /.card-body -->
                                    <div class="card-footer">
                                        <button type="submit" name="create_admin" class="btn btn-primary">Enregistrer</button>
                                    </div>
                                </form>
                            </div>
                        <?php endif;?>
